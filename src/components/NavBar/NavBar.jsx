        ...
        <Navbar className='bg-black bg-opacity-95 text-3xl text-main p-3 md:px-60 fixed shadow-md shadow-main ' >
            ...
            <NavbarContent justify="end">
                <NavbarItem className="flex">
                    <a href="#footer" className='border-main hover:bg-main p-2 border-2 rounded-xl font-medium hover:text-black text-main duration-200 cursor-pointer text-medium'>
                        Contact
                    </a>
                </NavbarItem>
                <a
                    target='_blank'
                    href="https://drive.google.com/file/d/1wUGfPVgMEPqrPcPtOvJ_5ORT_SvXLzYi/view?usp=drive_link"
                    className="border-main hover:bg-main p-2 border-2 rounded-xl font-medium hover:text-black text-main duration-200 cursor-pointer text-center  text-sm md:text-medium"
                >
                    Download CV
                </a>
            </NavbarContent>
